...
export default function BookingForm({ className, ...props }: BookingFormProps) {
  ...
  return (
    <div className="bg-secondary  pt-16 max-md:-mt-4 max-md:rounded-t-xl">
      <div
      ...
      >
        ...
        <form
          className="mt-8 rounded-xl bg-white px-5 py-4 shadow md:mt-16 md:px-8 md:py-7"
        ...
        >
          ...
          {fields.map((field) => (
            <div
              key={field.label}
              className="space-y-2 border-b border-border/10 py-4 text-background focus-within:border-border/40 md:space-y-8"
            >
